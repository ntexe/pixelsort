...
options:
  ...
  -sg segmentation  Segmentation. Available choices: none, edge, melting, blocky, chunky. Default is edge.
...
#### Chunky
Fixed length is used to determine segments. Use -l argument to adjust length.
